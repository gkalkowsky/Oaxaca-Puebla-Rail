...
|---|---|---|---|---|
| R-01 | **REFRAMED AND EVIDENCED.** The reserve has **no core/buffer zoning** — the declaratoria set only a general polygon (PM 2013 p.140). The real constraint is subzonal: general infrastructure construction is a permitted activity **only** in *Aprovechamiento Especial*, which is **239.2 ha (0.049%)** across 14 quarry/saltworks/landfill polygons, none a transport corridor. Elsewhere only infrastructure *in support of* research/education/tourism is permitted, and three of four large subzones prohibit "abrir senderos, brechas o caminos" | **high** | **fatal** — potentially forecloses independently of economics | Subzone polygon shapefile overlaid on the alignment; SEMARNAT determination on whether rehabilitating a pre-existing federal rail ROW is *construction* or *maintenance* under LGEEPA, and the MIA modality that follows. See `working/environmental-permitting.md` |
